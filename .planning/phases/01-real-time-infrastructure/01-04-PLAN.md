...
<task type="auto">
  <name>Task 1: Create boards router with CRUD and sharing endpoints</name>
  <files>routers/boards.py</files>
  <action>
Create routers/boards.py following patterns from routers/teams.py:
...
```
  ...
  <verify>
cd "C:\Users\Workshop\Desktop\AI-2\Claude RW+skills\TODO" && python -c "from routers.boards import router; print('boards router imported successfully'); print('Endpoints:', [r.path for r in router.routes])"
  </verify>
  <done>
boards router imports with all endpoints: POST /boards, GET /boards, GET /boards/{id}, DELETE /boards/{id}, POST /boards/{id}/share, DELETE /boards/{id}/share/{user_id}, DELETE /boards/{id}/share/public, GET /boards/{id}/link, GET /boards/{id}/permissions.
  </done>
</task>

<task type="auto">
  <name>Task 2: Register boards router in main.py</name>
...
<task type="auto">
  <name>Task 3: Create integration tests for board endpoints</name>
